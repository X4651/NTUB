function ch02_F(){
    ...
    if(text_count ==  0){        
        ...
        setTimeout(() => {
            ...
            ch02_maymaysad_img.style.opacity = 1      //顯示妹妹傷心臉
            create_text_click()
        }, "3000");
    ...
    //(1)
        ...
        switch(text_count){     //動畫
            case 6:
                ch02_maymaycry_img.classList.remove("ch02_maymaycry");    //把妹妹的CSS替換成有動作的
                ch02_maymaycry_img.classList.add("ch02_maymaycry_walk");
                ch02_maymaycry_img.style.opacity = 1                      //顯示妹妹哭臉
                ...
                setTimeout(() => {
                    ...
                    ch02_toy_f_img.style.opacity = 1
                    background_animation()
        ...
        ch02_maymaysad_img.style.opacity = 1 //顯示妹妹哭臉
        switch(text_count){     //動畫
            case 8:
            case 9:
                break
    ...
    //(2)
        ...
        switch(text_count){     //動畫
            case 13:        
                ch02_maymaycry_img.classList.remove("ch02_maymaycry");    //把妹妹移到指定位置
                ch02_maymaycry_img.classList.add("ch02_maymaycry2");
                ...
                break
            case 14:
                ch02_maymaycry_img.style.opacity = 0.5//妹妹半透明
    ...
    //(3)
        ...
        switch(text_count){     //動畫
            case 21:  
                ch02_txt1_img.style.opacity = 1//妹妹吸氣
                setTimeout(() => {
                    ch02_txt1_img.style.opacity = 0
                    ch02_txt2_img.style.opacity = 1//妹妹吐氣
                    create_text_click()
                }, "1500");
                break
            case 22://妹妹跟朋友
                ...
                ch02_friend_img.style.opacity = 1
                ch02_maymay_img.style.opacity = 1
                create_text_click()
                break
        }
    }
    ...
    //(4)
        ...
        switch(text_count){     //動畫
            ...
            case 30:
                ...
                ch02_maymay_img.classList.remove("ch02_maymay");
                ch02_maymay_img.classList.add("ch02_maymay2");
                ch02_maymay_img.style.opacity = 1
                break
        }
    }
    ...
    //(5)
        ...
        background_animation_clear()
        //動畫
        ch02_maymayhappy_img.style.opacity = 1
        ...
        create_Button_innerText()
        //動畫
        ch02_maymaysad_img.classList.remove("ch02_maymaysad2");
        ch02_maymaysad_img.classList.add("ch02_maymaysad");
        ch02_maymaysad_img.style.opacity = 1  //顯示妹妹哭臉
        ch02_Note1_img.style.opacity = 1
        ch02_Note2_img.style.opacity = 1
        ch02_Note3_img.style.opacity = 1
    ...
    //(6)
        ...
        switch(text_count){     //動畫
            case 38:
                ch02_maymaysad_img.classList.remove("ch02_maymaysad");
                ch02_maymaysad_img.classList.add("ch02_maymaysad2");
                ch02_maymaysad_img.style.opacity = 1
                ch02_txt4_img.style.opacity = 1
                create_text_click()
                break
            case 39:
                ch02_maymaycry_img.classList.remove("ch02_maymaycry_walk");
                ch02_maymaycry_img.classList.add("ch02_maymaycry5");
                ch02_maymaysad_img.style.opacity = 0
                ch02_maymaycry_img.style.opacity = 1
            ...
            case 40:
                ...
                background_animation_clear()
                ch02_maymaysad_img.classList.remove("ch02_maymaysad2");
                ch02_maymaysad_img.classList.add("ch02_maymaysad3");
                ch02_maymaycry_img.style.opacity = 0
                ch02_maymaysad_img.style.opacity = 1
                ...
                setTimeout(() => {
                    ...
                    ch02_maymaysad_img.style.opacity = 0
                    ch02_maymaystopcrying_img.style.opacity = 1
                    create_text_click()
                }, "1500");
                break
            case 41:
        ...
        switch(text_count){     //動畫
            case 42:
                ch02_maymaysad_img.classList.remove("ch02_maymaysad3");
                ch02_maymaysad_img.classList.add("ch02_maymaysad");
                ch02_maymaysad_img.style.opacity = 1
                break
            case 43:
    ...
    //(7)
        ...
        create_Button_innerText()
        ch02_maymaystopcrying_img.classList.remove("ch02_maymaystopcrying");
        ch02_maymaystopcrying_img.classList.add("ch02_maymaystopcrying2");
        ch02_maymaystopcrying_img.style.opacity = 1
    }
    //(8)
        ...
        switch(text_count){     //動畫
            ...
            case 50:
                ch02_maymaystopcrying_img.classList.remove("ch02_maymaystopcrying");
                ch02_maymaystopcrying_img.classList.add("ch02_maymaystopcrying3");
                ch02_maymaystopcrying_img.style.opacity = 1
    ...
    //END
        ...
        switch(text_count){     //動畫
            ...
            case 68:        //END3
                ...
                background_animation_clear()
                ch02_end3_1_img.style.opacity = 1
                break
            case 69:
                ch02_end3_1_img.style.opacity = 1
                break
            case 70:
                ch02_end3_2_img.style.opacity = 1
                page = 999
                break
            case 71:        //END4
                background_animation()
                ...
                break
            case 72:
                ch02_end4_2_img.style.opacity = 1
                page = 999
                break
            case 73:        //END5
                background_animation()
            ...
            case 86:        //END10
                ...
                bg.setAttribute('src', '圖庫/綠色（溝通）.png')
                background_animation_clear()
                ch02_end10_F_img.style.opacity = 1
                break
            case 87:
                ch02_end10_F_img.style.opacity = 1
                break
    ...
    function create_text_end(){
        text_number = game2_text[text_count].length + 2
    ...
    function create_text_click(){
        create_text_clickNumber++
        if (create_text_clickNumber == 2){
            text.addEventListener('click', ch02_F)      //設定click事件
