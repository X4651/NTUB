function ch01_F(){
    ...
    if(text_count >=  0 && text_count <= 7){
        ...
        switch(text_count){     //動畫
            ...
            case 4:
                ...
                create_text_click()
                ch01_maymay_img.style.opacity = 1
                break
            case 5:
                create_text_click()
                ch01_mom_img.style.opacity = 1
                ch01_fridge_img.style.opacity = 1
                ch01_maymayhappy_img.style.opacity = 1
                break
            case 6:
                create_text_click()
                ch01_maymayscared_img.style.opacity = 1
                break
            case 7:
                create_text_click()
        ...
        switch(text_count){     //動畫
            case 8:
                ch01_maymayscared_img.classList.remove("ch01_maymayscared");    //讓妹妹驚訝表情移到左下
                ch01_maymayscared_img.classList.add("ch01_maymayscared2");
                ch01_maymayscared_img.style.opacity = 1
                break
            case 9:
                ch01_maymayangry_img.style.opacity = 1
                break
            case 10:
                ch01_maymaycry_img.style.opacity = 1
                break
            case 11:
                ch01_maymaystopcry_img.style.opacity = 1
                break
            case 12:
                ch01_maymayscared_img.style.opacity = 1
                break
    ...
    //(1)
        ...
        switch(text_count){     //動畫
            case 13:
                break
            case 14:
                ch01_maymayangry_img.classList.remove("ch01_maymayangry");    //讓妹妹生氣表情移到左邊
                ch01_maymayangry_img.classList.add("ch01_maymayangry2");
                ch01_maymayangry_img.style.opacity = 1
        ...
        switch(text_count){     //動畫
            case 16:
                ch01_maymayangry_img.classList.remove("ch01_maymayangry2");    //讓妹妹生氣表情移回左下
                ch01_maymayangry_img.classList.add("ch01_maymayangry");
                ch01_maymayangry_img.style.opacity = 1
                break
            case 17:
                ch01_maymayscared_img.style.opacity = 1
    ...
    //(2)
        ...
        switch(text_count){     //動畫
            case 21:
                ch01_maymaycry_img.classList.remove("ch01_maymaycry");    //讓妹妹大哭表情移到中間
                ch01_maymaycry_img.classList.add("ch01_maymaycry2");
                ch01_maymaycry_img.style.opacity = 1
                break
            case 22:
                ch01_maymaycry_img.style.opacity = 1
        ...
        switch(text_count){     //動畫
            case 23:
                ch01_maymaycry_img.classList.remove("ch01_maymaycry2");    //讓妹妹大哭表情回到左下
                ch01_maymaycry_img.classList.add("ch01_maymaycry");
                ch01_maymaycry_img.style.opacity = 1
                break
            case 24:
                ch01_maymaysad_img.style.opacity = 1
                break
            case 25:
                ch01_maymayangry_img.style.opacity = 1
                break
            case 26:
                ch01_maymay_img.classList.remove("ch01_maymay");    //讓妹妹回到左下
                ch01_maymay_img.classList.add("ch01_maymay2");
                ch01_maymay_img.style.opacity = 1
                break
        }
    }
    //(3)
        ...
        background_animation_clear()
        ch01_maymayangry_img.classList.remove("ch01_maymayangry");    //讓妹妹生氣表情移到右邊
        ch01_maymayangry_img.classList.add("ch01_maymayangry3");
        ch01_maymayangry_img.style.opacity = 1
        ...
        switch(text_count){     //動畫
            case 28:
                ch01_maymayangry_img.classList.remove("ch01_maymayangry3");    //讓妹妹生氣表情移回左下
                ch01_maymayangry_img.classList.add("ch01_maymayangry");
                ch01_maymayangry_img.style.opacity = 1
                break
            case 29:
    ...
    //(4)
        ...
        create_text()
        ch01_maymaysad_img.classList.remove("ch01_maymaysad");    //讓妹妹走回房間
        ch01_maymaysad_img.classList.add("ch01_maymaysad_walk");
        ...
        setTimeout(() => {
            ...
            bg.setAttribute('src', '圖庫/主角房間(溝通).png')
            background_animation_clear()
            ch01_maymayread_img.style.opacity = 1
        }, "2000");
        //動畫
    }
    else if(text_count >= 34 && text_count <= 38){
        create_Button_innerText()
        ch01_maymayhappy_img.classList.remove("ch01_maymayhappy");    //讓妹妹開心表情移到左下
        ch01_maymayhappy_img.classList.add("ch01_maymayhappy2");
        ch01_maymaysad_img.classList.remove("ch01_maymaysad_walk");    //讓妹妹回左下
        ch01_maymaysad_img.classList.add("ch01_maymaysad");
        switch(text_count){     //動畫
            case 34:
                ch01_maymaysad_img.style.opacity = 1
                break
    ...
    //(5)
        ...
        switch(text_count){     //動畫
            case 40:
                ch01_maymaycry_img.classList.remove("ch01_maymaycry2");    //讓妹妹大哭表情移回左下
                ch01_maymaycry_img.classList.add("ch01_maymaycry");
                ch01_maymaycry_img.style.opacity = 1
                break
            case 41:
    ...
    //(6)
        ...
        create_text_click()
        //動畫
        ch01_maymay_img.classList.remove("ch01_maymay");    //讓妹妹移到左中
        ch01_maymay_img.classList.add("ch01_maymay3");
        ch01_maymay_img.style.opacity = 1
        ...
        switch(text_count){     //動畫
            case 44:
                ch01_maymay_img.classList.remove("ch01_maymay3");    //讓妹妹移回左下
                ch01_maymay_img.classList.add("ch01_maymay2");
                ch01_maymay_img.style.opacity = 1
                break
            case 45:
    ...
    //END
        ...
        switch(text_count){     //動畫
            case 47://結局一
                ...
                bg.setAttribute('src', '圖庫/主角房間(溝通).png')
                background_animation_clear()
                ch01_maymaysad_img.classList.remove("ch01_maymaysad");    //讓妹妹跑到中間
                ch01_maymaysad_img.classList.add("ch01_maymaysad2");
                ch01_maymaysad_img.style.opacity = 1
                create_text_click()
                break
            case 48:
            ...
            case 58://結局三
                ...
                bg.setAttribute('src', '圖庫/藍色（溝通）.png')
                create_text_click()
                ch01_maymay_img.classList.remove("ch01_maymay");
                ch01_maymay_img.classList.add("ch01_maymay3");
                ch01_gg_img.style.opacity = 1
                ch01_maymay_img.style.opacity = 1
                break
            ...
            case 60:
                create_text_click()
                ch01_gghappy_img.style.opacity = 1
                ch01_maymay_img.style.opacity = 0.5
                break
            case 61:
                create_text_click()
                ch01_maymayhappy_img.classList.remove("ch01_maymayhappy");
                ch01_maymayhappy_img.classList.add("ch01_maymayhappy3");
            ...
            case 62://結局四
                background_animation()
                bg.setAttribute('src', '圖庫/藍色（溝通）.png')
                ch01_txt1_img.style.opacity = 1//妹妹吸氣
                setTimeout(() => {
                    ch01_txt1_img.style.opacity = 0
                    ch01_txt2_img.style.opacity = 1//妹妹吐氣
                    create_text_click()
                }, "1500");
                break
            case 63:
                create_text_click()
                ch01_txt2_img.style.opacity = 1
                break
            case 64:
                create_text_click()
                ch01_gg_hug_img.style.opacity = 1
                page = 999
                break
            case 65://結局五
                background_animation()
            ...
            case 71:
                create_text_click()
                ch01_maymayhappy_img.classList.remove("ch01_maymayhappy");
                ch01_maymayhappy_img.classList.add("ch01_maymayhappy4");
                ch01_maymayhappy_img.style.opacity = 1
                ch01_mom_img.style.opacity = 0.5
                page = 999
                break
            case 72://結局六
                ...
                bg.setAttribute('src', '圖庫/藍色（溝通）.png')
                create_text_click()
                ch01_maymaysad_img.classList.remove("ch01_maymaysad");
                ch01_maymaysad_img.classList.add("ch01_maymaysad3");
                ch01_maymaysad_img.style.opacity = 1
                break
            case 73:
                create_text_click()
            ...
            case 76:
                create_text_click()
                ch01_maymayhappy_img.style.opacity = 0.5
                ch01_mom_img.style.opacity = 1
                page = 999
                break
            case 77://結局八
            ...
            case 78:
                create_text_click()
                ch01_maymay_img.classList.remove("ch01_maymay2");
                ch01_maymay_img.classList.add("ch01_maymay3");
            ...
            case 84:
                ...
                ch01_maymay_img.classList.remove("ch01_maymay3");
                ch01_maymay_img.classList.add("ch01_maymay4");
            ...
            case 91://結局十
                ...
                bg.setAttribute('src', '圖庫/藍色（溝通）.png')
                create_text_click()
                ch01_end10_img.style.opacity = 1
                page = 999
                break
        }
    }else{
    ...
    function create_text(){
        ...
        setTimeout(() => {
            if(text_number <= game1_text_F[text_count].length + 1){
                text.innerText = game1_text_F[text_count].slice(0,text_number)      //讀取字串中的字
                text_number++
                create_text()       //再次呼叫，以形成迴圈來逐一顯示
            }else if(text_number > game1_text_F[text_count].length + 1){      //字串顯示完成，設定click
    ...
    function create_text_end(){
        text_number = game1_text_F[text_count].length + 2     //讓create_text()的迴圈結束到else if來去執行create_text_click()
        text.innerText = game1_text_F[text_count]      //顯示完整敘述
    ...
    function create_text_click(){
        ...
        if (create_text_clickNumber == 2){
            text.addEventListener('click', ch01_F)      //設定click事件
    ...
    function create_Button_innerText(){     //建立按鈕與事件 設定文字敘述
        ...
        text.innerText = game1_text_F[text_count]
    }
